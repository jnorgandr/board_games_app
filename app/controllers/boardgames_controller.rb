class BoardgamesController < ApplicationController
  ...
  def delete_image
    begin
      @boardgame_image = ActiveStorage::Attachment.find(params[:image_id])
      @boardgame_image.purge
      redirect_to boardgame_path(@boardgame), notice: 'Imagen eliminada con exito'
  ...
  private
    ...
    def boardgame_params
      params.require(:boardgame).permit(:name, :rules, :box_image, :rules_pdf, pieces_images: [], boards_images: [])
    end
end
